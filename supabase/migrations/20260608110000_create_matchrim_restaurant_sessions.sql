...
DROP POLICY IF EXISTS "Users can insert own restaurant sessions"
...
DROP POLICY IF EXISTS "Users can read own restaurant sessions"
ON public.restaurant_matchrim_sessions;
...
DROP POLICY IF EXISTS "Users can update own restaurant sessions"
ON public.restaurant_matchrim_sessions;
...
DROP POLICY IF EXISTS "Admins can read restaurant demand"
ON public.restaurant_matchrim_sessions;
