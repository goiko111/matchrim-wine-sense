...
- Los flujos que requieren cuenta o perfil conservan el contexto: desde un QR/restaurante, la barra inferior, el header o una CTA publica, el usuario puede hacer login/registro o crear Matchrim y volver al destino esperado.
