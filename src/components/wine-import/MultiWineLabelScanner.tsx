        ...
        <>
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex gap-2">
              ...
              {!loading && (
                <Button type="button" variant="outline" size="icon" className="h-11 w-11" onClick={resetScan} aria-label="Cerrar análisis">
                  <X className="h-4 w-4" />
                </Button>
              )}
            </div>
            ...
            <div className="mx-auto flex w-full max-w-2xl min-h-0 flex-1 flex-col">
              ...
              <div className="min-h-0 flex-1 space-y-4 overflow-y-auto px-4 pb-4">
                {selectedRegion.cropDataUrl && (
                  <img src={selectedRegion.cropDataUrl} alt={`Recorte de la región ${selectedRegion.index}`} className="max-h-48 w-full bg-black object-contain" />
                )}
