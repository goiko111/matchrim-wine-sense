...
export const PDFImport = ({ onImportComplete }: PDFImportProps) => {
  ...
  const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      reader.onloadend = async () => {
        ...
        const { data, error } = await supabase.functions.invoke('extract-wines-pdf', {
          body: { pdf: base64PDF }
        });
        ...
        if (data.wines && data.wines.length > 0) {
          ...
          toast.info("No se encontraron vinos en el PDF");
        }
      };
  ...
  return (
    <div className="space-y-4">
      <div className="text-sm text-gray-600 space-y-2">
        <p>✅ Catálogos de bodegas</p>
        <p>✅ Cartas de vino (hasta 50 páginas)</p>
        <p>✅ Listas de inventario</p>
