...
interface RestaurantOCRImportProps {
  onImportComplete: (wines: WineWithPrice[]) => void;
  onImportStart?: () => void;
}

export const RestaurantOCRImport = ({ onImportComplete, onImportStart }: RestaurantOCRImportProps) => {
  ...
  const processImage = async (file: File) => {
    ...
    try {
      ...
      reader.onloadend = async () => {
        ...
        const { data, error } = await supabase.functions.invoke('extract-restaurant-ocr', {
  ...
  return (
    <div className="space-y-4">
      <div className="text-sm text-gray-600 space-y-2">
        <p>✅ Cartas de vino de restaurantes</p>
        <p>✅ Menús con precios al público</p>
        <p>✅ Listas de vinos</p>
      </div>
